...
def design_template_edit(request, pk):
    ...
    # Render the form
    return render(request, 'design_template_form.html', {
        'form': form,
...
def save_template_canvas(request, template_id):
    ...
    try:
        ...
        # If a preview image was sent (as base64)
        preview_image_data = data.get('preview_image')
        if preview_image_data:
            # Add your base64 image processing here if needed
            pass
...
def design_template_list(request):
    ...
    return render(request, 'design_template_list.html', {
        'templates': templates,
        'product_types': product_types,
        'categories': categories,
