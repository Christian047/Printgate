# Generated by Django 5.1.3 on 2025-03-27 13:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('order', models.IntegerField(default=0, help_text='Display order')),
                ('default_width', models.IntegerField(default=800, help_text='Default canvas width in pixels')),
                ('default_height', models.IntegerField(default=600, help_text='Default canvas height in pixels')),
